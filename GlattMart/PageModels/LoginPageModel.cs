...
namespace GlattMart.PageModels
{
    public class LoginPageModel:FreshMvvm.FreshBasePageModel, INotifyPropertyChanged
    {
        ...
        private string _username ="gursewaksinghs@gmail.com";
                ...
                if (data != null)
                {
                    if (data.Data != null)
                    {
                        ...
                        if (resultSet.result == true)
                        {
                            ...
                            Settings.UserId = resultSet.model.id;
        ...
        public Command FacebookLoginCommand => new Command(FacebookLogin);

        private async void FacebookLogin()
        {
            await Application.Current.MainPage.Navigation.PopModalAsync(true);
            await Application.Current.MainPage.Navigation.PushAsync(new Pages.FacebookLogin() { Title = "Facebook" });
        }
    }
}